...
import type { Contract as End } from '../../snapshots/7bb20ae7d6faceb6ed459a43ec456c84494821043da5c5280b2a602a617539c0/contract';
import endContract from '../../snapshots/7bb20ae7d6faceb6ed459a43ec456c84494821043da5c5280b2a602a617539c0/contract.json' with { type: 'json' };
import {
  Migration,
  MigrationCLI,
  checkExpression,
  ...
  override get operations() {
    return [
      ...
      this.createIndex({
        schema: 'public',
        table: 'transaction',
        index: 'transaction_destinationWalletId_idx_b60ffc63',
      ...
      this.addForeignKey({
        ...
        table: 'transaction',
        foreignKey: {
          name: 'transaction_destinationWalletId_fkey',
          columns: ['destinationWalletId'],
          references: { schema: 'public', table: 'wallet', columns: ['id'] },
        },
      }),
